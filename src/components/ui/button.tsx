  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold font-body ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 uppercase tracking-wider",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground hover:scale-105 gym-pulse text-base md:text-lg py-4 px-8",
        heroOutline: "border-2 border-foreground/30 bg-transparent text-foreground hover:border-primary hover:text-primary hover:scale-105 text-base md:text-lg py-4 px-8",
        cta: "bg-primary text-primary-foreground hover:scale-105 gym-pulse font-display text-xl tracking-widest",
      },
      size: {
